...
download.file(fileUrl, destfile="./data/projectdata.zip", method="auto")

dateDownloaded<- date()
#Start reading files
setwd("C:/Users/HP/Documents/data/projectdata/UCI HAR Dataset")
# reading Activities Files
ActivityTest<- read.table("C:/Users/HP/Documents/data/projectdata/UCI HAR Dataset/test/y_test.txt", header=F)
ActivityTrain<-read.table("C:/Users/HP/Documents/data/projectdata/UCI HAR Dataset/train/y_train.txt", header=F)
#Reading features

FeaturesTest<- read.table("C:/Users/HP/Documents/data/projectdata/UCI HAR Dataset/test/X_test.txt", header=F)
FeatresTrain<-read.table("C:/Users/HP/Documents/data/projectdata/UCI HAR Dataset/train/X_train.txt", header =F)

#Reading subjects files

SubjectTest<-read.table("C:/Users/HP/Documents/data/projectdata/UCI HAR Dataset/test/subject_test.txt", header=F)
SubjectTrain<-read.table("C:/Users/HP/Documents/data/projectdata/UCI HAR Dataset/train/subject_train.txt", header=F)

#read activities Labels
ActivityLabels<- read.table("C:/Users/HP/Documents/data/projectdata/UCI HAR Dataset/activity_labels.txt", header=F)

#read features

FeaturesNames<- read.table ("C:/Users/HP/Documents/data/projectdata/UCI HAR Dataset/features.txt ", header=F)

####Merg dataframes: Features Test&Train,Activity Test&Train, Subject Test&Train
FeaturesData <- rbind(FeaturesTest,FeatresTrain )
